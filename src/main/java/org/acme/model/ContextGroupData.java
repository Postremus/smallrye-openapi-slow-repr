...
public class ContextGroupData   {
  private UUID id;
  private String matchCode;
  private TranslationHolderData name;

  public ContextGroupData() {
  }

    @JsonCreator
    public ContextGroupData(@JsonProperty(required = true, value = "matchCode") String matchCode) {
   ...
   **/
  public ContextGroupData id(UUID id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ContextGroupData matchCode(String matchCode) {
    this.matchCode = matchCode;
    return this;
  }
   ...
   **/
  public ContextGroupData name(TranslationHolderData name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ContextGroupData contextGroupData = (ContextGroupData) o;
    return Objects.equals(this.id, contextGroupData.id) &&
        Objects.equals(this.matchCode, contextGroupData.matchCode) &&
        Objects.equals(this.name, contextGroupData.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContextGroupData {\n");
