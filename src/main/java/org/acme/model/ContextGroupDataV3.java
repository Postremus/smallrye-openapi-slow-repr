...
@JsonTypeName("ContextGroupDataV3")
...
public class ContextGroupDataV3   {
  private UUID id;
  private String matchCode;
  private TranslationHolderData name;

  public ContextGroupDataV3() {
  }

    @JsonCreator
    public ContextGroupDataV3(@JsonProperty(required = true, value = "matchCode") String matchCode) {
   ...
   **/
  public ContextGroupDataV3 id(UUID id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ContextGroupDataV3 matchCode(String matchCode) {
    this.matchCode = matchCode;
    return this;
  }
   ...
   **/
  public ContextGroupDataV3 name(TranslationHolderData name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ContextGroupDataV3 contextGroupDataV3 = (ContextGroupDataV3) o;
    return Objects.equals(this.id, contextGroupDataV3.id) &&
        Objects.equals(this.matchCode, contextGroupDataV3.matchCode) &&
        Objects.equals(this.name, contextGroupDataV3.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContextGroupDataV3 {\n");
