...
public class TenantData   {
  ...
  /**
   **/
  public TenantData name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public TenantData matchCode(String matchCode) {
    this.matchCode = matchCode;
    return this;
  }
  ...
  /**
   **/
  public TenantData name2(String name2) {
    this.name2 = name2;
    return this;
  }
  ...
  /**
   **/
  public TenantData streetAndNumber(String streetAndNumber) {
    this.streetAndNumber = streetAndNumber;
    return this;
  }
  ...
  /**
   **/
  public TenantData appendix(String appendix) {
   ...
   **/
  public TenantData country(String country) {
    this.country = country;
    return this;
  }
   ...
   **/
  public TenantData zipCode(String zipCode) {
    this.zipCode = zipCode;
    return this;
  }
  ...
  /**
   **/
  public TenantData city(String city) {
    this.city = city;
    return this;
  }
  ...
  /**
   **/
  public TenantData district(String district) {
  ...
  /**
   **/
  public TenantData zipCodePoBox(String zipCodePoBox) {
  ...
  /**
   **/
  public TenantData poBox(String poBox) {
    this.poBox = poBox;
    return this;
  }
  ...
  /**
   **/
  public TenantData phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  /**
   **/
  public TenantData mobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  /**
   **/
  public TenantData fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  /**
   **/
  public TenantData email(String email) {
    this.email = email;
    return this;
  }
  ...
  /**
   **/
  public TenantData website(String website) {
   ...
   **/
  public TenantData accessGrants(List<@Valid TenantApplicationGrantData> accessGrants) {
  ...
  public TenantData addAccessGrantsItem(TenantApplicationGrantData accessGrantsItem) {
  ...
  public TenantData removeAccessGrantsItem(TenantApplicationGrantData accessGrantsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tenantData.id) &&
        Objects.equals(this.name, tenantData.name) &&
        Objects.equals(this.matchCode, tenantData.matchCode) &&
        Objects.equals(this.name2, tenantData.name2) &&
        Objects.equals(this.streetAndNumber, tenantData.streetAndNumber) &&
        Objects.equals(this.appendix, tenantData.appendix) &&
        Objects.equals(this.country, tenantData.country) &&
        Objects.equals(this.zipCode, tenantData.zipCode) &&
        Objects.equals(this.city, tenantData.city) &&
        Objects.equals(this.district, tenantData.district) &&
        Objects.equals(this.zipCodePoBox, tenantData.zipCodePoBox) &&
        Objects.equals(this.poBox, tenantData.poBox) &&
